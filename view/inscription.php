...
<form action="index.php?page=inscription" method="post">
    ...
    <input type="email" name="mail_u" placeholder="Email">
    <input type="tel" name="telephone_u" placeholder="Téléphone">
    <input type="password" name="motdepass_u" placeholder="Password">
    <input type="password" name="motdepass_u_conf" placeholder="Confirmation du password">
